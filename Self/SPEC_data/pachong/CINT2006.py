...
url = "https://spec.org/cpu2006/results/cint2006.html"
...
obj2 = re.compile('<tr.*?'
                  ...
                  '<td class="sw_auto_parallel">(?P<Auto>.*?)</td>.*?'
...
f = open("Data/CINT2006.csv", mode="w", newline="")
csvwriter = csv.writer(f)
csvwriter.writerow(['TestSponsor', 'SystemName', 'AutoParallel', 'EnabledCores', 'EnabledChips', 'Cores/Chips', 'Threads/Core', 'Base', 'Peak'])
for i in result1:
