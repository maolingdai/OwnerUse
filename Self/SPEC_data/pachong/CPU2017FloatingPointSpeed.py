...
url = "https://spec.org/cpu2017/results/cfp2017.html"
...
f = open("Data/CPU2017 Floating Point Speed.csv", mode="w", newline="")
csvwrite = csv.writer(f)
csvwrite.writerow(['TestSponsor', 'SystemName', 'Parallel', 'BaseThreads', 'EnabledCores', 'EnabledChips', 'Threads/Core', 'Base', 'Peak', 'EnergyBase','EnergyPeak'])
