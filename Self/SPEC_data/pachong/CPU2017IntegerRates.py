...
url = "https://spec.org/cpu2017/results/rint2017.html"
...
obj2 = re.compile(r'<tr.*?<td class="test_sponsor">(?P<test_sponsor>.*?)</td>.*?'
...
f = open("Data/CPU2017 Integer Rates Results.csv", mode="w", newline="")
